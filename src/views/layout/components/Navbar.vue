  ...
  <el-menu class="navbar" mode="horizontal">
    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item" trigger="click">
        ...
        <img class="user-avatar" src="https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTI9JdRricv0X491CjmshXibUyEN7DibcBOSkkKWdU3v3opzaZhOjveAv36TRyArPSlfS6kjSmqicfgkBQ/132">
